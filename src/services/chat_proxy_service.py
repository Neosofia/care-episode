...
from src.services.async_risk_evaluation import schedule_risk_evaluation_after_chat
...
def _maybe_schedule_risk_evaluation(
    *,
    episode: CareEpisode,
    patient_uuid: str,
    ...
    schedule_risk_evaluation_after_chat(
        ...
        tenant_uuid=_jwt_tenant_uuid() or str(episode.tenant_uuid),
        patient_display_name=_patient_display_name(payload),
    )
...
def proxy_chat_completion(
    ...
    _maybe_schedule_risk_evaluation(
        episode=episode,
        patient_uuid=patient_uuid,
        chat_interaction_uuid=chat_interaction_uuid,
        payload=payload,
